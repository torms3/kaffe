...
def multiscale_filter(outsz, phase):
    ...
    # The net itself.
    n.conv1a, n.relu1a = conv_relu(n['input'], 60, [1,5,5], lr_mult)
    n.conv1b, n.relu1b = conv_relu(n.relu1a,   60, [1,5,5], lr_mult)

    # Params for multiscale filter layers.
    ds = [1,2,3,4,5,6]  # Dilations for each convolution group.
    ns = 10             # Number of convolution groups.
